...
helm upgrade --install k8s-monitoring grafana/k8s-monitoring -n monitoring --create-namespace --wait --values monitoring.yaml --set-file extraConfig=configs/suo.alloy --version ^1
